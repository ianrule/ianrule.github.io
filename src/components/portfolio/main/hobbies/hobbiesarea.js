...
import HobbiesPage from './pricingarea/hobbiespage';
import HobbiesHeader from './pricingarea/pricingpage/hobbiesheader';
import HobbiesBody from './pricingarea/pricingpage/hobbiesbody';
import List from './pricingarea/pricingpage/hobbiesbody/list';
import ListItem from './pricingarea/pricingpage/hobbiesbody/list/listitem';
import HobbiesFooter from './pricingarea/pricingpage/hobbiesfooter';
        ...
        return (
            <div className="navigation-wrapper">
                <ul className="nav" id="myTab" role="tablist">
                    ...
                    <li className="nav-item">
                        <a className="nav-style" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Mental Health Advocacy</a>
                    </li>
                    <li className="nav-item">
