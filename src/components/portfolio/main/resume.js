...
import SingleTab from './resume/singletab'
import SkillList from './resume/singletab/skilllist';
import ListElement from './resume/singletab/skilllist/listelement';
import ProgressChart from './resume/singletab/progresschart';
import ProgressBar from './resume/singletab/progresschart/progressbar';
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title text-center">
                                ...
                                <h2 className="title">Ian Rule's Resume</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-12">
                            <ul className="rn-nav-list nav nav-tabs" id="myTabs" role="tablist">
                                <li className="nav-item">
                                    <a className="nav-link active" id="education-tab" data-bs-toggle="tab" href="#education" role="tab" aria-controls="education" aria-selected="true">Education & Work Experience</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="professional-tab" data-bs-toggle="tab" href="#professional" role="tab" aria-controls="professional" aria-selected="false">Technical & Soft Skills</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="experience-tab" data-bs-toggle="tab" href="#experience" role="tab" aria-controls="experience" aria-selected="false">Awards & Certifications</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="interview-tab" data-bs-toggle="tab" href="#interview" role="tab" aria-controls="interview" aria-selected="false">Clubs & Volunteer Work</a>
                                </li>
                            </ul>
