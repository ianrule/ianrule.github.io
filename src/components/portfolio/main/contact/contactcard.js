            ...
            <div className="col-lg-10">
                <div className="contact-about-area">
                    ...
                    <div className="description">
                        ...
                        <span className="phone">Phone: <a href={"tel:" + this.props.phone_number}>{this.props.phone_number}</a></span>
                        <span className="mail">Email: <a href={"mailto:" + this.props.email}>{this.props.email}</a></span>
                    </div>
                    <div className="social-area">
                        ...
                        <div className="social-icone">
                            ...
                            <a href={this.props.instagram_link}><i data-feather="instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
