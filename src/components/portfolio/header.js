            ...
            <div className="d-none d-xl-block">
                <header className="rn-header-area d-flex align-items-start flex-column left-header-style">
                    <div className="logo-area">
                        <a href="/">
                            <img src="assets/images/logo/IR.JPG" alt="personal-logo"></img>
                        </a>
                    </div>
                    <nav id="sideNavs" className="mainmenu-nav navbar-example2 onepagenav">
                        <ul className="primary-menu nav nav-pills">
                            ...
                            <li className="nav-item"><a className="nav-link smoth-animation-two" href="#features"><i><Icon.User></Icon.User></i>About Me</a></li>
                            <li className="nav-item"><a className="nav-link smoth-animation-two" href="#resume"><i><Icon.Briefcase></Icon.Briefcase></i>Resume</a></li>
                            <li className="nav-item"><a className="nav-link smoth-animation-two" href="#portfolio"><i><Icon.Layers></Icon.Layers></i>Projects</a></li>
                            <li className="nav-item"><a className="nav-link smoth-animation-two" href="#pricing"><i><Icon.Smile></Icon.Smile></i>Hobbies</a></li>
                            <li className="nav-item"><a className="nav-link smoth-animation-two" href="#contacts"><i><Icon.MessageCircle></Icon.MessageCircle></i>Contact</a></li>
                        </ul>
                    </nav>
